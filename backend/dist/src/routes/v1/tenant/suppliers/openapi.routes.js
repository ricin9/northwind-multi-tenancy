...
import { insertSupplierSchema, listSupplierQuerySearchSchema, listSupplierSchema, supplierSchema, updateSupplierSchema } from "./schema";
const tags = [
    "Suppliers"
];
export const list = createRoute({
    ...
    description: "Get a list of suppliers with filtering, pagination, and sorting",
    request: {
