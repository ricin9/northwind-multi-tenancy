...
import { insertCustomerSchema, customerSchema, updateCustomerSchema, listCustomerSchema, listCustomerQuerySearchSchema } from "./schema";
const tags = [
    "Customers"
];
export const list = createRoute({
    ...
    description: "Get a list of customers with filtering, pagination, and sorting",
    request: {
