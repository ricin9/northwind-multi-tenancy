...
export const updateCustomerSchema = insureOneProperty(baseInsertCustomerSchema.omit({
    customerId: true
}).partial());
...
export const listCustomerQuerySearchSchema = generateFPSSchemaForTable(customers);
