export declare const centralTSchema: {
    userRelations: import("drizzle-orm").Relations<"users", {
        company: import("drizzle-orm").One<"companies", true>;
    }>;
    companyRelations: import("drizzle-orm").Relations<"companies", {
        users: import("drizzle-orm").Many<"users">;
    }>;
    companies: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
        name: "companies";
        schema: undefined;
        columns: {
